...
void
ui_draw_minutes (uint8_t minutes)
{
...
void
ui_draw_seconds (uint8_t seconds)
{
...
ui_draw_dots ()
{
  uint8_t dot[] = { 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0,
...
void
ui_draw_timer (uint8_t minutes, uint8_t seconds)
{
...
void
ui_print_centered (const char *str)
{
  uint8_t len;
  uint8_t start;
  uint8_t c;
...
void
ui_draw_wait_for_button (uint8_t prev_state)
{
